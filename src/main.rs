...
mod app {
    ...
    fn init(cx: init::Context) -> (DataCommon, DataLocal, init::Monotonics) {
        ...
        **********************************************************************/
        ...
        (
            ...
            init::Monotonics(systick_monotonic::Systick::new(cx.core.SYST, 48_000_000)),
        )
    }
    ...
    **************************************************************************/
    #[task(binds = USB, shared = [usb_manager])]
